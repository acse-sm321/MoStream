...
type Err struct {
	...
	ErrorCode string `json:"error_code"` // note this is not status code
}
...
var (
	ErrorRequestBodyParseFailed = ErrorResponse{HttpSC: 400, Error: Err{Error: "Request body cannot be resolved", ErrorCode: "001"}}
